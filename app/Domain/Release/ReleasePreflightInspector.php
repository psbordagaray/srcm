...
final class ReleasePreflightInspector
{
    ...
    private function numericIntegrityPolicyIsPresent(): bool
    {
        ...
        return enum_exists(\App\Domain\Numerics\NumericKind::class)
            ...
            && class_exists(\App\Domain\Commerce\CommerceSettlementDiscrepancyDecisionException::class)
            && class_exists(\App\Domain\Commerce\CommerceSettlementReviewRecorder::class)
            && class_exists(\App\Models\CommerceSettlementReview::class)
            && class_exists(\App\Domain\Commerce\CommerceSettlementReviewResolutionData::class)
            && class_exists(\App\Domain\Commerce\CommerceSettlementReviewResolutionManager::class)
            && class_exists(\App\Models\CommerceSettlementReviewResolution::class)
            && enum_exists(\App\Enums\CommerceSettlementReviewResolutionOutcome::class)
            ...
            && ($policy['discrepancy_framework']['commerce_settlement_decision_runtime_exception_foundation_version'] ?? null)
                === \App\Domain\Commerce\CommerceSettlementDiscrepancyDecisionException::FOUNDATION_VERSION
            && ($policy['discrepancy_framework']['commerce_settlement_decision_runtime_exception_schema'] ?? null)
                === \App\Domain\Commerce\CommerceSettlementDiscrepancyDecisionException::SCHEMA
            && ($policy['discrepancy_framework']['commerce_settlement_decision_runtime_exception_class'] ?? null)
                === \App\Domain\Commerce\CommerceSettlementDiscrepancyDecisionException::class
            && ($policy['discrepancy_framework']['commerce_settlement_decision_runtime_exception_message'] ?? null)
                === \App\Domain\Commerce\CommerceSettlementDiscrepancyDecisionException::MESSAGE
            && ($policy['discrepancy_framework']['commerce_settlement_decision_runtime_wiring_status'] ?? null)
                === \App\Domain\Commerce\CommerceSettlementDiscrepancyDecisionException::RUNTIME_WIRING_STATUS
            && ($policy['discrepancy_framework']['commerce_settlement_decision_runtime_hard_fail_preserved'] ?? null)
                === true
            && ($policy['discrepancy_framework']['commerce_settlement_decision_runtime_settlement_review_required'] ?? null)
                === true
            && ($policy['discrepancy_framework']['commerce_settlement_decision_runtime_sale_confirmation_authorized'] ?? null)
                === false
            && ($policy['discrepancy_framework']['commerce_settlement_decision_runtime_business_mutation_authorized'] ?? null)
                === false
            && ($policy['discrepancy_framework']['commerce_settlement_decision_runtime_automatic_correction'] ?? null)
                === false
            && ($policy['discrepancy_framework']['commerce_settlement_decision_runtime_audit_persistence'] ?? null)
                === false
            && ($policy['discrepancy_framework']['commerce_settlement_decision_runtime_controller_special_handling'] ?? null)
                === true
            && ($policy['discrepancy_framework']['commerce_settlement_review_persistence_foundation_version'] ?? null)
                === \App\Domain\Commerce\CommerceSettlementReviewRecorder::FOUNDATION_VERSION
            && ($policy['discrepancy_framework']['commerce_settlement_review_persistence_recorder_class'] ?? null)
                === \App\Domain\Commerce\CommerceSettlementReviewRecorder::class
            && ($policy['discrepancy_framework']['commerce_settlement_review_persistence_model_class'] ?? null)
                === \App\Models\CommerceSettlementReview::class
            && ($policy['discrepancy_framework']['commerce_settlement_review_persistence_runtime_status'] ?? null)
                === \App\Domain\Commerce\CommerceSettlementReviewRecorder::RUNTIME_WIRING_STATUS
            && ($policy['discrepancy_framework']['commerce_settlement_review_persistence_boundary'] ?? null)
                === 'controller_post_manager_rollback_dedicated_decision_exception_catch'
            && ($policy['discrepancy_framework']['commerce_settlement_review_persistence_checkout_idempotent'] ?? null)
                === true
            && ($policy['discrepancy_framework']['commerce_settlement_review_persistence_conflict_fails_closed'] ?? null)
                === true
            && ($policy['discrepancy_framework']['commerce_settlement_review_persistence_requires_sale'] ?? null)
                === false
            && ($policy['discrepancy_framework']['commerce_settlement_review_persistence_hard_fail_preserved'] ?? null)
                === true
            && ($policy['discrepancy_framework']['commerce_settlement_review_persistence_sale_confirmation_authorized'] ?? null)
                === false
            ...
            && ($policy['discrepancy_framework']['commerce_settlement_review_persistence_audit_full_evidence_duplicated'] ?? null)
                === false
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_foundation_version'] ?? null)
                === \App\Domain\Commerce\CommerceSettlementReviewResolutionManager::FOUNDATION_VERSION
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_manager_class'] ?? null)
                === \App\Domain\Commerce\CommerceSettlementReviewResolutionManager::class
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_data_class'] ?? null)
                === \App\Domain\Commerce\CommerceSettlementReviewResolutionData::class
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_model_class'] ?? null)
                === \App\Models\CommerceSettlementReviewResolution::class
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_outcome_enum_class'] ?? null)
                === \App\Enums\CommerceSettlementReviewResolutionOutcome::class
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_outcome_values'] ?? null)
                === \App\Enums\CommerceSettlementReviewResolutionOutcome::values()
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_cardinality'] ?? null)
                === 'one_final_resolution_per_review'
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_storage'] ?? null)
                === 'separate_append_only_immutable_record'
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_capability'] ?? null)
                === 'canResolveCommerceSettlementReview'
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_admin_only'] ?? null)
                === true
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_audit_event'] ?? null)
                === \App\Domain\Commerce\CommerceSettlementReviewResolutionManager::AUDIT_EVENT
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_audit_atomic_with_create'] ?? null)
                === true
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_identical_retry_idempotent'] ?? null)
                === true
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_conflict_fails_closed'] ?? null)
                === true
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_second_final_fails_closed'] ?? null)
                === true
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_sale_creation_authorized'] ?? null)
                === false
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_payment_rewrite_authorized'] ?? null)
                === false
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_receivable_rewrite_authorized'] ?? null)
                === false
            && ($policy['discrepancy_framework']['commerce_settlement_review_resolution_business_mutation_authorized'] ?? null)
                === false
            ...
            && ($policy['discrepancy_framework']['commerce_settlement_component_analysis_runtime_decision_wiring'] ?? null) === true

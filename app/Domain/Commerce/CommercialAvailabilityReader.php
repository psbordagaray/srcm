...
final class CommercialAvailabilityReader
{
     ...
     * policy, publishability, protected minimums and backorder/preorder remain
     * unopened.
     *
    ...
    {
        $positions = $this->physicalAvailability
            ->positions($actor)
            ->values();
        ...
        return $positions->map(function (
        ...
        ) use ($reserved): CommercialAvailabilityPosition {
            $restrictions = [];
            ...
            $afterReservations = InventoryQuantity::subtract(

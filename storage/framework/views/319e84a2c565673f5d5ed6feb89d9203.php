...
<svg <?php echo e($attributes->merge(['class' => 'h-5 w-5 shrink-0'])); ?> viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
    <?php switch($name):
        case ('dashboard'): ?>
...
<?php /**PATH C:\laragon\www\srcm\resources\views/components/sidebar-icon.blade.php ENDPATH**/ ?>
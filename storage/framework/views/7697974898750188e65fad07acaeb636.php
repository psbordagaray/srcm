...
>
    ...
    <div class="flex-1 overflow-y-auto px-4 py-6">
        ...
        <nav class="mt-3 space-y-1">
            <?php $__currentLoopData = $navigation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <a href="<?php echo e($href); ?>" class="sulu-nav-item <?php echo e($isActive ? 'sulu-nav-item-active' : ''); ?>">
                    <?php echo $__env->make('components.sidebar-icon', ['name' => $item['icon']], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <nav class="mt-3 space-y-1">
            <?php $__currentLoopData = $operations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($item['href']); ?>" class="sulu-nav-item">
                    <?php echo $__env->make('components.sidebar-icon', ['name' => $item['icon']], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <span><?php echo e($item['label']); ?></span>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="border-t border-white/10 p-4">
        ...
        <div class="mt-4 flex items-center gap-2">
            <a href="<?php echo e(route('profile.edit')); ?>" class="sulu-nav-item flex-1">
                <?php echo $__env->make('components.sidebar-icon', ['name' => 'settings'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <span>Mi perfil</span>
            </a>
...
<?php /**PATH C:\laragon\www\srcm\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>
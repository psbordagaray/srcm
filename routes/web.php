        ...
        ->group(function () {
            ...
            Route::middleware('can:review-financial-reconciliation')
                ->group(function () {
                    ...
                    Route::post(
                        'financial/reconciliation/payments/{commercePayment}/resolve-difference',
                        [FinancialReconciliationController::class, 'resolveDifference']
                    )
                        ->whereNumber('commercePayment')
            ...
            Route::middleware('can:record-commerce-post-sale')
                ->group(function () {
                    ...
                    Route::get(
                        'commerce/post-sale/{commercePostSaleRequest:public_id}/receipts/create',
                        [CommercePostSaleReceiptController::class, 'create']
                    )
                        ->whereUuid('commercePostSaleRequest')
                        ->name('commerce-post-sale.receipts.create');

                    Route::post(
                        'commerce/post-sale/{commercePostSaleRequest:public_id}/receipts',
                        [CommercePostSaleReceiptController::class, 'store']
                    )
                        ->whereUuid('commercePostSaleRequest')
            ...
            Route::middleware('can:receive-purchases')
                ->group(function () {
                    ...
                    Route::post(
                        'purchases/{purchaseOrder}/supplier-invoices',

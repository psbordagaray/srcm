    ...
    <div class="space-y-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex flex-wrap gap-3">
                @can('view-purchases')
                    <a
                        href="{{ route('suppliers.account', $supplier) }}"
                        class="inline-flex items-center justify-center rounded-xl border border-amber-400/30 px-4 py-2.5 text-sm font-semibold text-amber-200"
                    >
                        Estado de cuenta
                    </a>
                @endcan
